    ...
    <section className="services" id="services">
      ...
      <div className="services__grid reveal-group">
        <div className="services__card reveal">
          <img className="card__icon" src={helmetIcon} />
          <h3 className="card__title">Execução de Obras</h3>
        ...
        <div className="services__card reveal">
          <img className="card__icon" src={boardIcon} />
          <h3 className="card__title">Gerenciamento de Obras</h3>
          <p className="card__description">
        ...
        <div className="services__card reveal">
          <img className="card__icon" src={rulerIcon} />
          <h3 className="card__title">Projetos Arquitetônicos</h3>
          <p className="card__description">
        ...
        <div className="services__card reveal">
          <img className="card__icon" src={graphicIcon} />
          <h3 className="card__title">Orçamentos Detalhados</h3>
          <p className="card__description">
        ...
        <div className="services__card reveal">
          <img className="card__icon" src={buildIcon} />
          <h3 className="card__title">Reformas</h3>
          <p className="card__description">
        ...
        <div className="services__card reveal">
          <img className="card__icon" src={hammerIcon} />
          <h3 className="card__title">Reformas</h3>
          <p className="card__description">
            Modernização e revitalização de espaços existentes, mantendo
            qualidade estrutural e estética.
